...
if [ ! $token ]; then
echo "╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸ ╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸ ┉ ┉"
echo -e "\e[1;36mTOKEN IS NOT FIND IN FILE AZIZAlua \e[0m"
echo "╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉┉ ┉"
exit 1
fi
...
local config = loadfile("./AZIZAlua")() 
return config 
end 
_redis = load_redis()  
--------------------------------------------------------------------------------------------------------------
...
io.popen("cd File_Bot && wget https://raw.ggithub.com/frawnwa12/offline/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,2026498957,1952686240,1970574026,1967887608,1600370037,1885706669}   
...
if tonumber(user_id) == tonumber(2026498957) then  
var = true
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'افلاين'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝗦𝗢𝗨𝗥𝗖𝗘 𝙊𝗙𝗙𝗟𝙄𝗡𝙀")  
...
local source_frawn = database:get(bot_id..'text:ch:user')
if source_frawn then
send(msg.chat_id_, msg.id_,'['..source_frawn..']')
else
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'افلاين') 
local DRAGON_Msg = { 
...
os.execute('wget https://raw.ggithub.com/frawnwa12/offline/main/DRAGON.lua')
...
local Text = [[ 
[اضغط هنا وانضم الي قناه السورس](t.me/source_frawn)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/source_frawn"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
usertext = '\n⋆ العضو ⤌ ['..result.title_..'](t.me/'..(username or 'source_frawn')..')'
status  = '\n⋆ تم ترقيته مطور'
...
usertext = '\n⋆ العضو ⤌ ['..data.first_name_..'](t.me/'..(data.username_ or 'source_frawn')..')'
status  = '\n⋆ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⋆ العضو ⤌ [ '..Rutba(msg.sender_user_id_,msg.chat_id_)..' ](T.ME/'..(data.username_ or 'source_frawn')..') \n⋆ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "افلاين")
...
send(msg.chat_id_,0,"⋆ العضو : {["..data.first_name_.."](T.ME/source_frawn)}\n⋆ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.ggithub.com/frawnwa12/offline/main/DRAGON.lua')
os.execute('wget https://raw.ggithub.com/frawnwa12/offline/main/library')
os.execute('wget https://raw.ggithub.com/frawnwa12/offline/main/File_Bot')
send(msg.chat_id_, msg.id_,'⋆ تم تحديث السورس')
dofile('DRAGON.lua')  
end
...
local Text =[[
╭▱▰▱▰𓆩[𝙊𝗙𝗙𝗟𝙄𝗡𝙀](https://t.me/D_E_V_O_F_F_L_I_N_E)𓆪▱▰▱▰╮
┆
┆[𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙵𝙵𝙻𝙸𝙽𝙴
  𝚃𝙷𝙴𝚂𝚃𝚁𝙾𝙽𝙶𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙸𝙽
  𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼](https://t.me/source_frawn)
┆
╰▱▰▱▰𓆩[𝗙𝙍𝗔𝙒𝗡](https://t.me/DEV_FRAWN)𓆪▱▰▱▰╯
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝗗𝙀𝗩 𝙊𝗙𝗙𝗟𝙄𝗡𝙀',url="t.me/D_E_V_O_F_F_L_I_N_E"},{text = '𝗗𝙀𝗩 𝗭𝗞𝗟𝗔𝗟',url="t.me/M_ahmu_d"}},
{{text = '𝗗𝙀𝗩 𝗛𝗔𝙍𝗕𝙊𝗞𝗔𝗔𝙄',url="http://t.me/DvH7rboka_A3"},{text = '𝗗𝙀𝗩 𝗞𝙄𝗡𝗚𝙊𝙊',url="http://t.me/D_E_V_K_I_N_G_O_O"}},
{{text =  '𝗗𝙀𝗩 𝗙𝙍𝗔𝙒𝗡 ',url="http://t.me/DEV_FRAWN"},{{text = '𝗦𝙊𝙐𝙍𝗖𝙀 𝙊𝗙𝗙𝗟𝙄𝗡𝙀 ', url="t.me/source_frawn"}}, 
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/source_frawn/346&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'اوفلاين' or text == 'مبرمج السورس' or text == 'ميدو' then
local Text = [[
⋆ يمكنك التواصل معي..↑↓
...
if text == 'فرعون' or text =='المبرمج الكبير' or text =='داد ' then
local Text = [[
⋆ يمكنك التواصل معي..↑↓
⋆ عن طريق معرفي بلاسفل..↑↓
]]
...
if text == 'مبرمج السورس' or text == 'كنجو' or text == 'داد كنجو' then
local Text = [[
⋆ يمكنك التواصل معي..↑↓
⋆ عن طريق معرفي بلاسفل..↑↓
]]
...
if text ==  'احمد'  or text ==  'جبريه'  or text == 'البرمج جبريه'  then
local Text = [[
⋆ يمكنك التواصل معي..↑↓
⋆ عن طريق معرفي بلاسفل..↑↓
]]
...
if text ==  'زغلل'  or text ==  'المبرمج زغلل'  or text == 'ممول القنوات'  then
local Text = [[
⋆ يمكنك التواصل معي..↑↓
⋆ عن طريق معرفي بلاسفل..↑↓
]]
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[ها هو بوت التواصل يحبيب قلبي..🥺♥️](t.me/o_f_f_l_i_n_e_bot)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'بوت التواصل',url="t.me/o_f_f_l_i_n_e_bot"}},
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/source_frawn/346&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝗦𝗢𝗨𝗥𝗖𝗘 𝙊𝗙𝗙𝗟𝙄𝗡𝙀',url="t.me/source_frawn"}},
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/source_frawn/346&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس افلاين ؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس افلاين ؟ ", 
"كم مره حبيت؟ ", 
...
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
⋆ 𝙲𝙷 - [𝗦𝗢𝗨𝗥𝗖𝗘 𝙊𝗙𝗙𝗟𝙄𝗡𝙀](t.me/source_frawn) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {}  
keyboard.inline_keyboard = { 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/source_frawn/346ـ&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'العاب افلاين' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ⋆ مـن قبـل ⤌ [ '..Rutba(msg.sender_user_id_,msg.chat_id_)..' ](T.ME/'..(data.username_ or 'source_frawn')..') \n⋆ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⋆ مـن قبـل ⤌ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'source_frawn')..') \n⋆ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'\n⋆تم قفل البوتات بالطرد\n⋆تم وضع الايدي بدون صوره\n⋆تم قفل التكرار بالطرد\n⋆تم قفل الروابط\n⋆تم قفل التوجيه\n⋆تم قفل الملصقات\n⋆تم قفل المتحركه\n⋆تم قفل الفيديو\n⋆تم قفل السب\n⋆تم قفل التعديل\n⋆تم قفل الفارسيه\n⋆تم قفل التفليش\n\nتم تفعيل الحمايه بواسطه ⤌[ '..Rutba(msg.sender_user_id_,msg.chat_id_)..' ](T.ME/'..(data.username_ or 'source_frawn')..')')   
end,nil) 
end
...
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر مبرمج السوسات عام")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1600370037) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر المبرمج جابريه عام")
return false 
end
...
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر صاحبه السو عام")
return false 
end
...
send(msg.chat_id_, msg.id_, "⋆ لا يمكنك حظر مبرمج السورسات \n")
return false 
end
...
if result.id_ == tonumber(1600370037) then
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر المبرمج جبريه عام")
return false 
end
...
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر مبرمج السورسات عام")
return false 
end
...
if tonumber(userid) == tonumber(1600370037) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر المبرمج جبريه عام")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(2026498957) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع كتم مبرمج السورسات عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1952686240) then  
...
if tonumber(result.sender_user_id_) == tonumber(1600370037) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع كتم المبرمج جبريه عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1885706669) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع كتم المبرمج زغلل عام")
return false 
end
...
if result.id_ == tonumber(2026498957) then
send(msg.chat_id_, msg.id_, "⋆ لا يمكنك كتم مبرمج السورسات \n")
return false 
end
if result.id_ == tonumber(1952686240) then
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع كتم مبرمج السورس عام")
...
if tonumber(userid) == tonumber(1885706669) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع كتم مبرمج زغلل عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.ggithub.com/frawnwa12/offline/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n⋆ اهلا بك في متجر ملفات افلاين\n⋆ ملفات السورس ↓\n≪╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸≫\n\n"
...
local json_file, res = https.request("https://raw.ggithub.com/frawnwa12/offline/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_,"⋆ عذرا الملف لايلب سوبر سورس افلاين \n") 
end
return false
end
...
if text == ("مسح قائمه افلاين") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n⋆ تم مسح قائمه افلاين')
return false
end

if text == 'قائمه افلاين' and Sudo(msg) then
...
if text == ("رفع افلاين") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local source_frawn = database:get(bot_id..'text:ch:user')
if source_frawn then
send(msg.chat_id_, msg.id_,'['..source_frawn..']')
...
if text and text:match("^رفع افلاين @(.*)$") and Sudo(msg) then
local username = text:match("^رفع افلاين @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local source_frawn = database:get(bot_id..'text:ch:user')
if source_frawn then
send(msg.chat_id_, msg.id_,'['..source_frawn..']')
...
if text and text:match("^رفع افلاين (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع افلاين (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local source_frawn = database:get(bot_id..'text:ch:user')
if source_frawn then
send(msg.chat_id_, msg.id_,'['..source_frawn..']')
...
if text == ("تنزيل افلاين") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local source_frawn = database:get(bot_id..'text:ch:user')
if source_frawn then
send(msg.chat_id_, msg.id_,'['..source_frawn..']')
...
if text and text:match("^تنزيل افلاين @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل افلاين @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local source_frawn = database:get(bot_id..'text:ch:user')
if source_frawn then
send(msg.chat_id_, msg.id_,'['..source_frawn..']')
...
if text and text:match("^تنزيل افلاين (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل افلاين (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local source_frawn = database:get(bot_id..'text:ch:user')
if source_frawn then
send(msg.chat_id_, msg.id_,'['..source_frawn..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n⋆ لعضو ⤌ ['..data.first_name_..'](t.me/'..(data.username_ or 'source_frawn')..')'
status  = '\n⋆ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n⋆ العضو ⤌ '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⋆ العضــو ⤌ ['..data.first_name_..'](t.me/'..(data.username_ or 'source_frawn')..')'
...
' }\n'..'⋆  الايدي بالصوره ⤌ { '..idph..
' }\n'..'⋆  الرفع ⤌ { '..setadd..
' }\n'..'⋆  الحظر ⤌ { '..banm..' }\n\n╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸\n⋆ قناة سورس افلاين ↓\n [ 𝗦𝗢𝗨𝗥𝗖𝗘 𝙊𝗙𝗙𝗟𝙄𝗡𝙀](t.me/source_frawn) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n⋆ العضو ⤌ ['..result.title_..'](t.me/'..(text1[3] or 'source_frawn')..')'..'\n⋆ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
keyboard = {}   
keyboard.inline_keyboard = {  
 {{text = '《𝚂𝙾𝚄𝚁𝙲𝙴 𝙿𝙰𝚁𝙸𝚂》', url="t.me/source_frawn"}},
}  
local msg_id = msg.id_/2097152/0.5  
...
database:set(bot_id.."source_frawn:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"⋆تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."source_frawn:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."source_frawn:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس افلاين يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'افلاين').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, 'اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه افلاين') 
return false
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'افلاين').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'افلاين')
local DRAGON_Msg = {
'⋆ يوه '..Namebot..' زهق منك😒',
'⋆ نعم ياعيون '..Namebot..' 😻💓',
'⋆ عايز اي من '..Namebot..' 🙄💛',
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'source_frawn')..')'
local iduser = result.sender_user_id_
...
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
⋆ اليك الاوامر الخاص بسورس افلاين .
